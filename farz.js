...
module.exports = farz = async (farz, mek) => {
	try {
      ...
      const sendFileFromUrl = async(link, type, options) => {
          ...
          if (!packname) packname = '𝑫𝒂𝒇𝒚'; if (!author) author = '𝑾𝑰𝑩𝑼𝑺𝑶𝑭𝑻';author = author.replace(/[^a-zA-Z0-9]/g, '');	
       ...
       return d.toLocaleDateString(locale, { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric', hour: 'numeric', minute: 'numeric', second: 'numeric'
        ...
        if (isCmd && isGroup)
           ...
           case 'creator':
               ...
               buttons = [{buttonId: `${prefix}sourcecode`,buttonText:{displayText: '𝑬𝒔𝒄𝒆'},type:1},{buttonId:`${prefix}infoig`,buttonText:{displayText:'𝑰𝑮'},type:1}]
...
`
gbutsan = [
{buttonId:`owner`,buttonText:{displayText:'</ 𝑫𝒂𝒇𝒚'},type:1}
]
